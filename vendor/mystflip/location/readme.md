...
[![GitHub Actions](https://img.shields.io/github/workflow/status/Mystflip/location/run-tests.svg?style=flat-square)](https://github.com/Mystflip/location/actions)
[![Scrutinizer Code Quality](https://img.shields.io/scrutinizer/g/Mystflip/location.svg?style=flat-square)](https://scrutinizer-ci.com/g/Mystflip/location/?branch=master)
[![Latest Stable Version](https://img.shields.io/packagist/v/Mystflip/location.svg?style=flat-square)](https://packagist.org/packages/Mystflip/location)
[![Total Downloads](https://img.shields.io/packagist/dt/Mystflip/location.svg?style=flat-square)](https://packagist.org/packages/Mystflip/location)
[![License](https://img.shields.io/packagist/l/Mystflip/location.svg?style=flat-square)](https://packagist.org/packages/Mystflip/location)
...
```bash
composer require Mystflip/location
```
...
```php
Mystflip\Location\LocationServiceProvider::class
```

Publish the configuration file (this will create a `location.php` file inside the `config/` directory):

```bash
php artisan vendor:publish --provider="Mystflip\Location\LocationServiceProvider"
```
...
6. Set your default location `driver` to `Mystflip\Location\Drivers\MaxMind::class`, and you're all set!
...
use Mystflip\Location\Drivers\Driver;
