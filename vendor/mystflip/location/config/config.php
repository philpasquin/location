...
return [
    ...
    */
    ...
    'driver' => Mystflip\Location\Drivers\IpApi::class,
    ...
    */
    ...
    'fallbacks' => [
        ...
        Mystflip\Location\Drivers\IpInfo::class,

        Mystflip\Location\Drivers\GeoPlugin::class,

        Mystflip\Location\Drivers\MaxMind::class,
    ...
    */
    ...
    'position' => Mystflip\Location\Position::class,
